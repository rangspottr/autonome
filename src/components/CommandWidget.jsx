                ...
                <div className={styles.quickResult}>
                  <div className={styles.quickResultMeta}>
                    <span
                      ...
                      style={{
                        background: quickResponse.source !== 'local' ? 'rgba(16,185,129,0.1)' : 'rgba(245,158,11,0.1)',
                        color: quickResponse.source !== 'local' ? 'var(--color-success)' : 'var(--color-warning)',
                        padding: '2px 8px',
                    ...
                    >
                      {quickResponse.source !== 'local' ? '✦ AI' : '● Data-driven'}
                    </span>
                  </div>
                  ...
                  {quickResponse.ai_attempted && quickResponse.source === 'local' && (
                    <div className={styles.aiFallbackNotice}>
                      AI call to {quickResponse.provider_attempted || 'configured AI provider'} failed — showing data-driven summary.
